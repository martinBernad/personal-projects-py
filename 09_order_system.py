...
class Drink(Item):
    def __init__(self, name, price, volume:int):
        super().__init__(name, price)
        self.volume = volume
...
class Order:
    def __init__(self, customer_name:str, delivery_address:str, items:list, status:str):
...
class DeliveryPerson:
    def __init__(self, name:str, phone_number:str, available:bool=True, current_order=None):
        self.name = name
